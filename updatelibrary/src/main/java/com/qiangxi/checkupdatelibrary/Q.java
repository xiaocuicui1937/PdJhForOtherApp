...
public class Q {
     ...
     * @param callback           请求回调
     */
    public static void checkUpdate(String requestMethod, int currentVersionCode, String urlPath, @Nullable Map<String, String> params, @NonNull CheckUpdateCallback callback) {
