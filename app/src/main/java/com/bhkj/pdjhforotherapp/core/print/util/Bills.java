package com.bhkj.pdjhforotherapp.core.print.util;
...
public class Bills {
	 ...
	 * 1.排队小票
	 */
	public static void printSmallTicket(UsbDriver mUsbDriver, String title, String num, JhResultBean jhResultBean, int cutter) {
		try{
			// 小票标题
			...
			mUsbDriver.write(PrintCmd.SetSizetext(0, 0));
			// 小票主要内容
			mUsbDriver.write(PrintCmd.PrintString(Constant.STRDATA_CN_BEFORE, 1));
			mUsbDriver.write(PrintCmd.SetSizetext(1,1));
			mUsbDriver.write(PrintCmd.PrintString(String.valueOf(jhResultBean.getDatas().getQueuenum()),1));
			mUsbDriver.write(PrintCmd.SetSizetext(0, 0));
			mUsbDriver.write(PrintCmd.PrintString(Constant.STRDATA_CN_AFTER, 0));
			mUsbDriver.write(PrintCmd.PrintFeedline(1)); // 打印走纸2行

			mUsbDriver.write(PrintCmd.PrintString(Constant.JHTIME, 1));
			mUsbDriver.write(PrintCmd.SetSizetext(1,1));
			mUsbDriver.write(PrintCmd.PrintString(String.valueOf(jhResultBean.getDatas().getQueuetime()),1));
			mUsbDriver.write(PrintCmd.SetSizetext(0, 0));
			mUsbDriver.write(PrintCmd.PrintString(Constant.MIN, 0));
...
//			mUsbDriver.write(PrintCmd.SetAlignment(0));
	...
	public static void printBankBill(UsbDriver mUsbDriver,int cutter){
		mUsbDriver.write(PrintCmd.SetAlignment(1));
		mUsbDriver.write(PrintCmd.PrintString("交通银行自助设备交易凭条", 0));
