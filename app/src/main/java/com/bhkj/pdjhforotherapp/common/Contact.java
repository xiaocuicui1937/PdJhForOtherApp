...
public class Contact {
    ...
    public static final String BASE_URL = "http://192.168.43.209:8080/queue/";
    //获取业务类型
    public static final String GET_YW_TYPE = BASE_URL + "takenum/getOwner";
    public static final String GET_ALL_YW = "owner1.json";
    public static final String GET_ALL_YW2 = "/queue/owner1.json";
    public static final String GET_YW_ID = "ywid.json";
    //保存选择业务到服务器上
